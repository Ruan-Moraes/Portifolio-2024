...
export default async function fetchGitHubAPI() {
  ...
  try {
    ...
    const repositories = (await getValuesLocalStorage('repositories'))
...
async function requestAPI() {
  const repositoriesAddedManually = [
    'Accounts',
    'Translate-API',
    'To-do-list',
    'Proxy-translate',
  ...
  return await fetch(
    'https://api.github.com/users/ruan-moraes/repos?type=owner&per_page=128'
  )
